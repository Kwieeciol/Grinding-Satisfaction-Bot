...
class database:
    ...
    async def fetch_order(self, order_id: int) -> dict or list:
        """|coro|
    ...
    async def fetch_orders(self) -> dict or list:
        """|coro|
    ...
    async def fetch_customer(self, discord_id: int) -> dict or list:
        """|coro|
    ...
    async def fetch_customers(self) -> dict or list:
        """|coro|
    ...
    async def fetch_employee(self, discord_id: int) -> dict or list:
        """|coro|
    ...
    async def fetch_employees(self) -> dict or list:
        """|coro|
    ...
    async def fetch_storage(self, storage_id: int) -> dict or list:
        """|coro|
    ...
    async def fetch_storages(self) -> dict or list:
        """|coro|
    ...
    async def fetch_item(self, item_id: int) -> dict or list:
        """|coro|
    ...
    async def fetch_items(self) -> dict or list:
        """|coro|
