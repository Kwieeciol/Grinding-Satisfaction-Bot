...
class Database:
    ...
    async def assign_order(self, order: int, discord_id: int):
    ...
    async def set_progress(self, order: int, amount: int):
    ...
    async def edit(self, order: int, data: dict):
    ...
    async def collection(self, order: int):
    ...
    async def completed(self, order: int):
    ...
    async def cancel(self, order: int):
        """Cancel an order
    ...
    async def fetch_order(self, order: int):
    ...
    async def new_customer(self, data: dict):
    ...
    async def check_customer(self, discord_id: int):
    ...
    async def status(self, discord_id: int):
